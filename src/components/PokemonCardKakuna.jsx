...
function PokemonKakuna (){
    ...
    const pokemonData = async () => {
      try {
        ...
        const resEncounter = await fetch(
          "https://pokeapi.co/api/v2/pokemon/14/encounters",
        );
  ...
  return (
    <div className="">
      {finalData && (
        <div className="bg-white p-6 rounded-2xl shadow-lg h-134 max-w-sm w-200 text-center">
          <img
